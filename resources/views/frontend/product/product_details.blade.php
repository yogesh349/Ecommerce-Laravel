    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product">
            ...
            <div class="single-product-gallery-item" id="slide{{$img->id}}">
                <a data-lightbox="image-1" data-title="Gallery" href="{{asset('upload/products/Multi-Image/'.$img->image_name)}}">
                    <img class="img-responsive" alt="" src="{{asset('upload/products/Multi-Image/'.$img->image_name)}}" data-echo="{{asset('upload/products/Multi-Image/'.$img->image_name)}}"  width="100px"/>
                </a>
            ...
            <div id="owl-single-product-thumbnails">
                ...
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{$img->id}}">
                        <img class="img-responsive" alt="" src="{{asset('upload/products/Multi-Image/'.$img->image_name)}}" data-echo="{{asset('upload/products/Multi-Image/'.$img->image_name)}}" height="50px"/>
                    </a>
                </div>
				@endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<div class="description-container m-t-20">
								@if(session()->get('language') == 'hindi') {{ $product->short_desc_hin }} @else {{ $product->short_desci_en }} @endif
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'hindi') 
											{!! $product->long_desc_hin !!} @else {!! $product->long_desc_en !!} @endif</p>
									</div>	
								</div><!-- /.tab-pane -->

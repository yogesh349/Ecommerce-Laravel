								...
								<div id="owl-single-product">
									...
									<div class="single-product-gallery-item" id="slide{{$img->id}}">
										<a data-lightbox="image-1" data-title="Gallery"
											href="{{asset('upload/products/Multi-Image/'.$img->image_name)}}">
											<img class="img-responsive" alt=""
												src="{{asset('upload/products/Multi-Image/'.$img->image_name)}}"
												data-echo="{{asset('upload/products/Multi-Image/'.$img->image_name)}}"
												width="100px" />
										</a>
						...
						<div class='col-sm-6 col-md-7 product-info-block'>
							<div class="product-info">
								...
								<div class="description-container m-t-20">
									@if(session()->get('language') == 'hindi') {{ $product->short_desc_hin }} @else {{
									$product->short_desci_en }} @endif
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="price-box">
												...
												@else
												<span class="price">Rs {{
													$product->selling_price-$product->discount_price }}</span>
								...
								<div class="quantity-container info-container">
									<div class="row">
										...
										<div class="col-sm-7">
											<button  onclick="addToCart()" type="submit" class="btn btn-primary"><i
								...
								<div id="description" class="tab-pane in active">
									<div class="product-tab">
										<p class="text">@if(session()->get('language') == 'hindi')
											{!! $product->long_desc_hin !!} @else {!! $product->long_desc_en !!} @endif
										</p>
									</div>
								</div><!-- /.tab-pane -->

        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 col-sm-6 already-registered-login">
                ...
                <form class="register-form" method="POST" action="{{route('checkout.store')}}">
                    ...
                    <div class="form-group">
                        <label class="info-title" for="exampleInputEmail1"><b>Phone Number</b>
                            <span>*</span></label>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="">
                            <ul class="nav nav-checkout-progress list-unstyled">
                                ...
                                <li>
                                    <strong>Image: </strong>
                                    <img src="{{ asset('upload/products/thumbnail/'.$item->options->image) }}"
            ...
            <div class="panel-group">
                <div class="panel panel-default">
                    ...
                    <div class="row">
                        ...
                        <img src="{{ asset('frontend/assets/images/payments/cash.png') }}" width="60px"> 
...
<script>
    $(document).ready(function () {
        ...
        $('select[name="district_id"]').change(function (e) {
            ...
            $.ajax({
                type: "GET",
                url: "/city-get/ajax/" + district_id,
                dataType: "json",
                success: function (response) {
                    $.each(response, function (key, value) {
                        $('select[name="city_id"]').append('<option value=" ' + response[key].id + '">' + response[key].city_name + '</option>');

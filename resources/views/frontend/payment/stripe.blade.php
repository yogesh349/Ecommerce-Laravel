				...
				<div class="col-md-6">
					...
					<div class="checkout-progress-sidebar ">
						...
						<form action="{{route('esewa.payment')}}" method="POST">
							...
							<input value="{{$data['shipping_name']}}" name="shipping_name" type="hidden">
							<input value="{{$data['shipping_email']}}" name="shipping_email" type="hidden">
							<input value="{{$data['shipping_phone']}}" name="shipping_phone" type="hidden">

  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>YCOMMERCE</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
    ...
    <tr>
        <td>
          ...
          @endphp
            ...
            <strong>Address:</strong> {{ $div }},{{ $dis }}.{{ $city }} <br>
...
<h3>Products</h3>
  <table width="100%">
    ...
    <tbody>
      ...
      <tr class="font">
        <td align="center">
            <img src=" {{asset('upload/products/thumbnail/'.public_path($item->product->product_thumbnail))}}" height="60px;" width="60px;" alt="">
        ...
        <td align="center">          @if($item->size == NULL)
            ----
           @else
             {{ $item->size }}
           @endif</td>

                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_tags_hin" class="form-control"  data-role="tagsinput" value="{{$product->product_tags_en}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_en" class="form-control"  data-role="tagsinput" value="{{$product->product_color_en}}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_desc_en" id="textarea" class="form-control" placeholder="Textarea text">{{$product->short_desc_en}}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_desc_hin" id="textarea" class="form-control" placeholder="Textarea text">{{$product->short_desc_hin}}</textarea>
            ...
            <div class="box bt-3 border-info">
              ...
              <form action="{{route('update.product.image')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row row-sm">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img class="card-img-top" src="{{asset('upload/products/Multi-Image/'.$img->image_name)}}" alt="Card image cap">
                                <div class="card-body">
                                  <h5 class="card-title">
                                    <a href="{{route('product.multiImage.delete',$img->id)}}" class="btn btn-sm btn-danger" id="delete" title="Delete "><i class="fa fa-trash"></i></a>
                                  </h5>
                                  <p class="card-text">
                                    <div class="form-group">
                                        <label class="form-control-label" for="">Change Image <span class="text-danger">*</span></label>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box bt-3 border-info">
              ...
              <form action="{{route('update.product.thumbmail')}}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="product_id" value="{{$product->id}}">
                ...
                <div class="row row-sm">
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <img class="card-img-top" src="{{asset('upload/products/thumbnail/'.$product->product_thumbnail)}}" alt="Card image cap">
                                <div class="card-body">
                                  <p class="card-text">
                                    <div class="form-group">
                                        <label class="form-control-label" for="">Change Image <span class="text-danger">*</span></label>

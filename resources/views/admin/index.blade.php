...
<div class="container-full">
    ...
    <section class="content">
        <div class="row">
                ...
                <div class="box overflow-hidden pull-up">
                    <div class="box-body">							
                        ...
                        <div>
                            ...
                            <h3 class="text-white mb-0 font-weight-500">Rs {{ $today  }} <small class="text-success"><i class="fa fa-caret-up"></i> NPR</small></h3>
                        </div>
                    </div>
                </div>
            </div>
			...
			<h3 class="text-white mb-0 font-weight-500">Rs {{ $month }} <small class="text-success"><i class="fa fa-caret-up"></i> NPR</small></h3>
                        </div>
                    </div>
                </div>
            </div>
			...
			<h3 class="text-white mb-0 font-weight-500">Rs {{ $year }} <small class="text-danger"><i class="fa fa-caret-down"></i> NPR</small></h3>
                        </div>
                    </div>
                </div>
            </div>
